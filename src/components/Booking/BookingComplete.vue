    ...
    <div class="row inner-container">
      ...
      <div class="booking-detail-wrapper left-align col s12">
        <div class="ticket-details col s6">
          ...
          >Pensionärsbiljetter: {{bookingObject.seniorTickets }}</p>
        </div>
        <div class="seat-details col s6">
          ...
          <p
            ...
            :key="id"
          >Rad {{ seat.y + 1 }}, Plats {{ seat.x}}</p>
        </div>
      </div>

      <div class="nav-buttons col s12 m6 push-m3">
        <button class="btn waves-effect waves-light black col s12">Till startsidan</button>
      </div>
    </div>
  </div>
</template>
